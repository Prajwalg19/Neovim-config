...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["conform.nvim"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/conform.nvim",
  ...
  ["persisted.nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/persisted.nvim",
  ...
  ["tokyonight.nvim.git"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/tokyonight.nvim.git",
  ...
  ["vim-css-color"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/vim-css-color",
